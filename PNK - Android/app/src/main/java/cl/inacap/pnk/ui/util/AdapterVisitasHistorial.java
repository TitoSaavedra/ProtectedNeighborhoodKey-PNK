 ...
 * @version 1.0
 */
public class AdapterVisitasHistorial extends RecyclerView.Adapter<AdapterVisitasHistorial.ViewHolder> {
    //Campos de la clase
     ...
     */
    public AdapterVisitasHistorial(List<SolicitudVisita> solicitudVisitaList) {
    ...
    @NonNull
    @Override
    public AdapterVisitasHistorial.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_visita_historial,parent,false);
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull final AdapterVisitasHistorial.ViewHolder holder, int position) {
        ...
        holder.tvFechaVisita.setText("Fecha visita: "+dateFormat.format(solicitudVisitaList.get(position).getFechaVisita()));
        holder.tvHoraVisita.setText("Hora visita: "+solicitudVisitaList.get(position).getHoraVisita());
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvFechaVisita=(TextView)itemView.findViewById(R.id.tv_fecha_visita);
            tvHoraVisita=(TextView)itemView.findViewById(R.id.tv_hora_visita);
