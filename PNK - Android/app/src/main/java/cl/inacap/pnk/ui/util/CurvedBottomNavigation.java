...
/**
 * Esta clase se utiliza para crear la barra de navegacion que extiende la clase BottomNavigationView
 * @autor Desconocido
 */
public class CurvedBottomNavigation extends BottomNavigationView {
    ...
    /**
     * Metodo para realizar las animaciones
     * @param canvas El layout de la barra
     */
    @Override
